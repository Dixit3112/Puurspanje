        ...
        <div className="container">
          <div className="main-flex">
            ...
            <div className="flex-items">
              ...
              <a href="dixit.com">Belverzoek</a>
              <a href="dixit.com">Contact</a>
              <a href="dixit.com">Inloggen</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex-header">
            ...
            <div className="flex-main">
              <div className="header-items">
                <a href="dixit.com">Aanbod</a>
                <a href="dixit.com">Regio</a>
                <a href="dixit.com">Aanpak</a>
                <a href="dixit.com">Meer</a>
              </div>
              <div className="items">
                <h2>
